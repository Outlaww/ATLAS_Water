...
class CfgVehicles
{
	...
	class ATLAS_LHD_Light:ATLAS_LHD_1
	{
		...
		{
			class light_hide {animPeriod=1; initPhase=0;source = "user";};
		};
		class Reflectors
		{
			class Light1
	...
	class ATLAS_LHD_4: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class door_3 {animPeriod=1; initPhase=1;source = "user";sound = "MetalDoorsSound";};
				class door_4 {animPeriod=1; initPhase=1;source = "user";sound = "MetalDoorsSound";};
				class elev_int {animPeriod=3; initPhase=0;source = "user";};
				class elev_int_rail {animPeriod=1; initPhase=-0.7;source = "user";};
				class elev_int_rail_top {animPeriod=1; initPhase=-0.7;source = "user";};
				class elev_int_rail_bottom {animPeriod=1; initPhase=0;source = "user";};
				class hook_1 {animPeriod=2; initPhase=0;source = "user";};
		};
	...
	class ATLAS_LHD_5: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class door_5 {animPeriod=1; initPhase=1;source = "user";sound = "MetalDoorsSound"};
		};
		class UserActions
		{
			class OpenDoor5
	...
	class ATLAS_LHD_7: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class door_welldeck {animPeriod=15;initPhase=0;source = "user";};
				class door_welldeck_2 {animPeriod=15;initPhase=0;source = "user";};
				class door_welldeck_3 {animPeriod=15;initPhase=0;source = "user";};
		};
	...
	class ATLAS_LHD_house_2: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class door_1 {animPeriod=1; initPhase=1;source = "user";sound = "MetalDoorsSound"};
				class door_2_1 {animPeriod=1; initPhase=0;source = "user";sound = "MetalDoorsSound"};
				class door_2_2 {animPeriod=1; initPhase=0;source = "user";sound = "MetalDoorsSound"};
		};
		class UserActions
		{
			class OpenDoor1
	...
	class ATLAS_LHD_elev_1: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class elev_ext_1 {animPeriod=3; initPhase=0;source = "user";};
				class elev_ext_1_rail {animPeriod=1; initPhase=0;source = "user";};
		};
		class UserActions
		{
	...
	class ATLAS_LHD_elev_2: ATLAS_LHD_1
	{
		...
		class AnimationSources
		{
				class elev_ext_2 {animPeriod=3; initPhase=0;source = "user";};
				class elev_ext_2_rail {animPeriod=1; initPhase=0;source = "user";};
		};
		class UserActions
		{
	...
	/*
	class Land_Fregata_1: StaticShip
	{
		class eventhandlers
		{
			//init = "[(_this select 0)] execVM 'JTAC_Water\scripts\large_object_attach.sqf'";
		};
		model="\jtac_water\Fregata\Fregata_1.p3d";
		displayName = "Frigate bow";
		vehicleClass = "Ship";
		JTAC_Large_Object_sections[]={"Land_Fregata_2","Land_Fregata_3"};
		scope = 2;
		ladders[] =
		{
			{"ladder_1_on","ladder_1_off"}
		};
	};
	class Land_Fregata_2:JTAC_Anzac_base
	{
		vehicleClass = "Ship";
		scope = 2;
		displayname = "frigate mid";
		model="\jtac_water\Fregata\Fregata_2.p3d";
		ladders[] =
		{
			{"ladder_1_on","ladder_1_off"},
			{"ladder_2_on","ladder_2_off"},
			{"ladder_3_on","ladder_3_off"},
			{"ladder_4_on","ladder_4_off"},
			{"ladder_5_on","ladder_5_off"},
			{"ladder_6_on","ladder_6_off"}
		};
	};
	class Land_Fregata_3:JTAC_Anzac_base
	{
		displayname = "frigate stern";
		model="\jtac_water\Fregata\Fregata_3.p3d";
		ladders[] =
		{
			{"ladder_1_on","ladder_1_off"},
			{"ladder_2_on","ladder_2_off"},
